...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://freshinternjobsearch-shahzoabshafis-projects.vercel.app","https://freshinternjobsearch.vercel.app","http://localhost:5173",],   # Vite's dev server
    allow_methods=["GET"],
    allow_headers=["*"],
